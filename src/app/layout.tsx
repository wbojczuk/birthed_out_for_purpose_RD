...
import { Arimo, B612 } from 'next/font/google'
...
const primaryFont = Arimo({ subsets: ['latin'], weight: ["400", "500", "600", "700"], display: "swap", variable: "--primary-font" })
const secondaryFont = B612({ subsets: ['latin'], weight: ["400", "700"], display: "swap", variable: "--secondary-font" })
